...
public class WorldGeneratorDres implements IWorldGenerator {
	...
	private void generateDres(World world, Random rand, int i, int j) {
        ...
        WorldGeneratorCelestial.generateOre(world, rand, i, j, WorldConfig.convertToInt(CompatibilityConfig.cobaltSpawn.get(0)), 4, 3, 22, ModBlocksSpace.ore_cobalt.getStateFromMeta(meta), stone);
        WorldGeneratorCelestial.generateOre(world, rand, i, j, WorldConfig.convertToInt(CompatibilityConfig.copperSpawn.get(0)), 9, 4, 27, ModBlocksSpace.ore_iron.getStateFromMeta(meta), stone);
